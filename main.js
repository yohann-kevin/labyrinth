...
// var line1 = [CreationCase(5),CreationCase(10),CreationCase(1),CreationCase(7)];
// var line2 = [CreationCase(5),CreationCase(14),CreationCase(5),CreationCase(5)];
// var line3 = [CreationCase(4),CreationCase(1),CreationCase(8),CreationCase(5)];
// var line4 = [CreationCase(14),CreationCase(9),CreationCase(12),CreationCase(9)];
// var tabGames = [line1,line2,line3,line4]

// displayLabyrinth(tabGames);

// function CreationCase(image) {
//     var box = {
//         image : image,
//         left : getLeft(image),
//         top : getTop(image),
...
//         if(getBox(positionPlayer[0],positionPlayer[1]).bottom){
//             linePlayer++;
//         }
//     }
...
//         }
//     }
//     if(event.keyCode === 37 && columnPlayer>0){//gauche
//         if(getBox(positionPlayer[0],positionPlayer[1]).left){
//             columnPlayer--;
//         }
//     }
//     if(event.keyCode === 38 && linePlayer > 0){ // haut
//         if(getBox(positionPlayer[0],positionPlayer[1]).top){
//             linePlayer--;
//         }
//     }
//     if(event.keyCode === 39 && columnPlayer < nbColumn - 1){ // droite
//         if(getBox(positionPlayer[0],positionPlayer[1]).right){
//             columnPlayer++;
//         }
//     }
//     if(event.keyCode === 40 && linePlayer < nbLine - 1){ // bas
